<script>
  ...
  //Akselimassat lasku
  $: if (paikkalukuEtu && x1 && x2 && x3 && paikkalukuTaka && takaakseliOmamassa) {
  ...
  <div class="row">
    <div class="col-md">
      ...
      <div class="input-group input-group-sm mb-2">
        ...
        <input type="number" bind:value={etuakseliOmamassa} class="form-control" placeholder="Etuakseli" />
      ...
      <div class="input-group input-group-sm mb-2">
        ...
        <input type="number" bind:value={takaakseliOmamassa} class="form-control" placeholder="Taka-akseli" />
        <div class="input-group-append">
          <span class="input-group-text">kg</span>
        </div>
      </div>
    ...
    <div class="col-md">
      ...
      <div class="input-group input-group-sm mb-2">
        ...
        <input type="number" bind:value={paikkalukuEtu} class="form-control" placeholder="Edessä" />
        <div class="input-group-append">
      ...
      <div class="input-group input-group-sm mb-2">
        ...
        <input type="number" bind:value={paikkalukuTaka} class="form-control" placeholder="Takana" />
        <div class="input-group-append">
          <span class="input-group-text">kpl</span>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-md-9">
      <div class="input-group input-group-sm mb-1 etaisyys">
        <div class="input-group-prepend">
          <span class="input-group-text"> X1 - Etäisyys etuakseli -> etuistuimet </span>
        </div>
        <input type="number" bind:value={x1} class="form-control" placeholder="Etäisyys etuakseli -> etuistuimet" />
        <div class="input-group-append">
      ...
      <div class="input-group input-group-sm mb-1 etaisyys">
        <div class="input-group-prepend">
          <span class="input-group-text"> X2 - Etäisyys etuistuimet -> takaistuimet </span>
        </div>
        <input type="number" bind:value={x2} class="form-control" placeholder="Etäisyys etuistuimet -> takaistuimet" />
        <div class="input-group-append">
          <span class="input-group-text">m</span>
        </div>
      </div>
      ...
      <div class="input-group input-group-sm mb-1 etaisyys">
        <div class="input-group-prepend">
          <span class="input-group-text"> X3 - Etäisyys takaistuimet -> taka-akseli </span>
        </div>
        <input type="number" bind:value={x3} class="form-control" placeholder="Etäisyys takaistuimet -> taka-akseli" />
        <div class="input-group-append">
          <span class="input-group-text">m</span>
        </div>
      </div>
