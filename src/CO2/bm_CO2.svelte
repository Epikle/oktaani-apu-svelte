<script>
  ...
  $: if (omamassaCO2 && tehoCO2) {
    CO2 = (0.047 * omamassaCO2 + 0.561 * tehoCO2 + 56.621).toFixed(1);
...
<p class="mb-1">Bensiinimoottori ja manuaalivaihteisto</p>
...
<div class="input-group input-group-sm mb-3">
  ...
  <input
    type="text"
    class="form-control"
    placeholder={omamassaCO2 && tehoCO2 ? '0,047 x ' + omamassaCO2 + ' + 0,561 x ' + tehoCO2 + ' + 56,621 = ' + CO2 + ' => ' + CO2R : '0,047 m + 0,561 p + 56,621'}
    disabled />
