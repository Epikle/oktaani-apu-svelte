<script>
  ...
  $: if (kantavuus >= 680 && kantavuus < 1000 && osamaara <= 0.05 && kokonaismassa > 2500) {
    tulos = true;
...
<div class="container">
  ...
  <p class="lead">Tarkista täyttääkö pakettiauto autoverolain 8 § edellytykset</p>
  ...
  <div class="input-group input-group-sm mb-2">
    ...
    <input type="number" bind:value={teho} class="form-control" placeholder="Teho" />
    <div class="input-group-append">
  ...
  <div class="input-group input-group-sm mb-2">
    ...
    <input type="number" value={kantavuus} class="form-control" placeholder="Kantavuus" disabled />
    <div class="input-group-append">
      <span class="input-group-text">kg</span>
    </div>
  </div>
  <div class="input-group input-group-sm mb-2">
    ...
    <input type="number" value={osamaara} class="form-control" placeholder="Osamäärä" disabled />
  </div>
  <div class="input-group input-group-sm mb-2">
    <div class="input-group-prepend">
  ...
  <p class="font-italic small text-muted mb-0">- auton kokonaismassa on yli 2 500 kg</p>
  <p class="font-italic small text-muted mb-0">
    - autossa ei ole muita istuimia tai istuinten kiinnitykseen tarkoitettuja laitteita (pl. pyörätuolin kiinnittämiseen
    tarkoitetut laitteet) kuin kuljettajan istuin ja tämän vieressä olevat istuimet
  </p>
  <p class="font-italic small text-muted mb-0">
    - kokonaismassan ja omamassan välinen erotus (kantavuus) on vähintään 680 kg
  </p>
  <p class="font-italic small text-muted">
    - kantavuus alle 1000 kg ja tehon (kW) ja kokonaismassan (kg) osamäärä on enintään 0,05, tai kantavuus on vähintään
    1000 kg ja tehon ja kokonaismassan osamäärä on enintään 0,06
  </p>
